export const HeroData = [
  {
    ...
    // path of person in our directory
    bg: "#0be4d1",
    // bg of container
    delay: 0.1,
    // re;ated to animation
  },
  {
...
export const testimonialsData = [
  ...
  {
    comment:
      "I have been working with Kmyaan on our fundraising strategies. They understands the in depth strategies of Venture Capital and early stage fund raising/company",
    name: "Cheryl R. Weiss",
